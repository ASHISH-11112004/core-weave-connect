...
function Page() {
  return (
    <div className="space-y-6">
      <PageHeader
        title="Admin Panel"
        subtitle="HR & Leadership analytics, moderation, and management"
        action={
          <Badge color="purple">
      ...
      <Surface className="overflow-hidden">
        <div className="p-4 sm:p-5 border-b border-border flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            <h3 className="font-semibold">Announcement management</h3>
            <p className="text-xs text-muted-foreground">Moderate and schedule posts</p>
          </div>
          <button className="rounded-2xl gradient-primary text-white text-sm px-4 py-2 self-start sm:self-auto">
            New announcement
          </button>
        </div>
          ...
          <table className="w-full text-sm min-w-[520px]">
            <thead className="bg-muted/30 text-xs text-muted-foreground">
              <tr>
                ...
                <th className="text-left py-3 hidden sm:table-cell">Engagement</th>
              ...
              {announcements.map((a, i) => (
                ...
                >
                  ...
                  <td className="py-3 hidden sm:table-cell text-muted-foreground">
                    {a.reactions} reactions · {a.comments} comments
                  </td>
      ...
      <Surface className="p-5">
        <div className="flex items-start gap-3">
          <div className="h-10 w-10 rounded-2xl bg-amber-500/10 grid place-items-center text-amber-600">
          ...
          <button className="rounded-xl bg-muted text-sm px-3 py-2 hover:bg-muted/70">
            Review
          </button>
        </div>
      </Surface>
