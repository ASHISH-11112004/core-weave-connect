  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="Celebrate the people who make us better, every day."
        action={
          <button className="rounded-2xl gradient-primary text-white text-sm px-4 py-2.5 shadow-lg shadow-blue-500/20 inline-flex items-center gap-2">
            <Sparkles className="h-4 w-4" /> Recognize someone
          </button>
        }
      />
